  ...
  return (
    <div id = "LandingPage">
      <div className="hero">
        ...
        <p>
          <button className="btn" onClick={() => setLanguage("en")} style={{background: getLanguage() === "en" ? "#152238" : "#152238"}}>English</button>
          <button className="btn" onClick={() => setLanguage("es")} style={{background: getLanguage() === "es" ? "#152238" : "#152238"}}>Spanish</button>
        </p>
      </div>
