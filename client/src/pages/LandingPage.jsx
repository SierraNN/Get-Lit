  ...
  return (
    <div id = "LandingPage">
      <div className="hero">
        ...
        <p>
          <button className="btn" onClick={() => setLanguage("en")} style={{background: getLanguage() === "en" ? "#6699CC" : "#a7a7a7"}}>English</button>
          <button className="btn" onClick={() => setLanguage("es")} style={{background: getLanguage() === "es" ? "#6699CC" : "#a7a7a7"}}>Spanish</button>
        </p>
      </div>
